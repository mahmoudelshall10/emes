						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('cards/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.cards')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$cards->id}}) ؟
																</div>
...
{!! Form::open(['url'=>aurl('/cards/'.$cards->id),'method'=>'put','id'=>'cards','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="form-group">
    {!! Form::label('name',trans('admin.name'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
        {!! Form::text('name', $cards->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('icon', $cards->icon ,['class'=>'form-control','placeholder'=>trans('admin.icon')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('content', $cards->content ,['class'=>'form-control','placeholder'=>trans('admin.content')]) !!}
    </div>
</div>
<br>
