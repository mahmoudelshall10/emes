...
{!! Form::open(['url'=>aurl('/cards'),'id'=>'cards','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
		{!! Form::hidden('icon',old('icon'),['class'=>'form-control','placeholder'=>trans('admin.icon')]) !!}
		@include('admin.cards.icon')
    </div>
</div>
<br>
<div class="form-group">
