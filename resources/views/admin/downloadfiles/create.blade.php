...
{!! Form::open(['url'=>aurl('/downloadfiles'),'id'=>'downloadfiles','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<br>
<div class="form-group">
    {!! Form::label('link',trans('admin.link'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
