...
class ServiceFormsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.serviceforms.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 ...
                 'title'=>trans('admin.project_location'),
		    ],
				[
                 'name'=>'business_requirements',
                 'data'=>'business_requirements',
                 'title'=>trans('admin.business_requirements'),
		    ],
				[
                 'name'=>'other_country',
                 'data'=>'other_country',
                 'title'=>trans('admin.other_country'),
		    ],
				[
                 'name'=>'additional_attachments',
                 'data'=>'additional_attachments',
                 'title'=>trans('admin.additional_attachments'),
		    ],
				[
                 'name'=>'linked_files',
                 'data'=>'linked_files',
                 'title'=>trans('admin.linked_files'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
