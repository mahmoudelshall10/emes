...
class TeamsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.teams.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'career_type',
                 'data'=>'career_type',
                 'title'=>trans('admin.career_type'),
		    ],
				[
                 'name'=>'rate_range_monthly_from',
                 'data'=>'rate_range_monthly_from',
                 'title'=>trans('admin.rate_range_monthly_from'),
		    ],
				[
                 'name'=>'rate_range_monthly_to',
                 'data'=>'rate_range_monthly_to',
                 'title'=>trans('admin.rate_range_monthly_to'),
		    ],
				[
                 'name'=>'rate_range_hourly_from',
                 'data'=>'rate_range_hourly_from',
                 'title'=>trans('admin.rate_range_hourly_from'),
		    ],
				[
                 'name'=>'rate_range_hourly_to',
                 'data'=>'rate_range_hourly_to',
                 'title'=>trans('admin.rate_range_hourly_to'),
		    ],
				[
                 'name'=>'cv_file',
                 'data'=>'cv_file',
