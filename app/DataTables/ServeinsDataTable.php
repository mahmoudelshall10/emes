...
class ServeinsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.serveins.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'longitude',
                 'data'=>'longitude',
                 'title'=>trans('admin.longitude'),
		    ],
				[
                 'name'=>'latitude',
                 'data'=>'latitude',
                 'title'=>trans('admin.latitude'),
		    ],
				[
                 'name'=>'company_phone',
                 'data'=>'company_phone',
				...
				[
                 'name'=>'company_email',
                 'data'=>'company_email',
                 'title'=>trans('admin.company_email'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
